<h2>Enter Details of Exisiting Provider to Update.</h2>
  ...
  <form action="" method="POST" role="form">
    ...
    <div class="form-group">
      <label for="providerNumber">Provider entity ID number</label>
      <input type="text" class="form-control" id="providerNumber" name="providerNumber" placeholder="Enter ID number for new Provider entity.">
    </div>
